...
class BaseConfig(object):
    ...
    def parse_base(self):
        ...
        self.parser.add_argument('--interpol', type=str, default='bilinear')       
        self.parser.add_argument('--lr_decay', type=float, default=1)
        ...
        self.parser.add_argument('--continuous_logistic', type=bool, default=True)
