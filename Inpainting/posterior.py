...
"""
import torch
from Inpainting.utils import nl_logistic_mixture_continous_test, discretized_mix_logistic_loss_1d
...
def logposterior(x, y, cont_logistic, net, net_interval, step):
    #x = x.reshape(y.shape)
    return torch.sum(nll_prior(net, cont_logistic, net_interval, step, x));