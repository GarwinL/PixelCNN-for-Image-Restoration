...
class BaseConfig(object):
    ...
    def parse_base(self):
        ...
        self.parser.add_argument('--optimizer', type=str, default='LBFGS')
        self.parser.add_argument('--lr_decay', type=float, default=0.999)
        self.parser.add_argument('--lr', type=float, default=0.05) 
        self.parser.add_argument('--net_name', type=str, default='net_epoch_5000.pt') 
        self.parser.add_argument('--sigma', type=float, default=25.)
        self.parser.add_argument('--alpha', type=float, default=0.48) #contionous: 0.03 discrete/continous_new: 0.6
