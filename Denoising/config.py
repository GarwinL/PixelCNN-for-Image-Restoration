...
class BaseConfig(object):
    ...
    def parse_base(self):
        ...
        self.parser.add_argument('--lr_decay', type=float, default=1) #Adam:0.999
        self.parser.add_argument('--lr', type=float, default=0.01)  #Adam:0.001
        self.parser.add_argument('--net_name', type=str, default='net_epoch_3000_2resnet_80filter.pt') 
        self.parser.add_argument('--sigma', type=float, default=50.)
        self.parser.add_argument('--alpha', type=float, default=0.6) #contionous: 0.03 discrete/continous_new: 0.6
        self.parser.add_argument('--control_epochs', type=int, default=5)
        self.parser.add_argument('--continuous_logistic', type=float, default=True)
        self.parser.add_argument('--crop_size', type=int, default=180)
